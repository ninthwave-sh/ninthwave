...
**Test plan:**
- Manual review of `README.md`, `ARCHITECTURE.md`, `docs/faq.md`, `docs/work-item-terminology.md`, and `CONTRIBUTING.md` for consistency with the shipped command and runtime behavior.
...
Key files: `README.md`, `ARCHITECTURE.md`, `docs/faq.md`, `docs/work-item-terminology.md`, `CONTRIBUTING.md`
